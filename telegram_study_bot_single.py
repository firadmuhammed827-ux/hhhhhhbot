...
{{"explanations": [{{"question": "Question", "answer": "Detailed answer"}}]}}"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_explanations.pdf"
...
{{"definitions": [{{"term": "Term", "definition": "Comprehensive definition"}}]}}"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_definitions.pdf"
...
{{"summary": [{{"point": "Summary point"}}]}}"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_summary.pdf"
...
- Example: Instead of "Given: W = 7.195 J, V = 1.77 V" write two steps:
  ...
  Step 2: "Stopping potential: V_s = 1.77 V"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_solutions.pdf"
...
- Each comparison should have at least 3-6 comparison aspects"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_differences.pdf"
...
- For theory: write clear and detailed answer"""
        ...
        # إنشاء PDF الاختبار (بدون إجابات)
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_exam.pdf"
...
async def generate_exam_solutions(query, context, exam_data: dict, user_id: int):
    ...
    try:
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_exam_solutions.pdf"
...
- Add real-life examples as much as possible"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_simple_explanation.pdf"
...
- Focus on what is typically asked in exams"""
        ...
        pdf_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_important_points.pdf"
...
قدم فقط نص الشرح، بدون تنسيق."""
        ...
        audio_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_explanation_{language}.mp3"
...
# إعداد التوكن الجديد
TOKEN = "8213416054:AAHHwAD0T30TwTbLKFVIPXwd8AUg9M-vH80"
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    os.makedirs("/home/ubuntu/telegram_study_bot/downloads", exist_ok=True)
    ...
    try:
        if message.photo:
            ...
            file_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_image.jpg"
            await photo_file.download_to_drive(file_path)
            content = await process_image(file_path)
            
        elif message.document:
            doc_file = await message.document.get_file()
            file_path = f"/home/ubuntu/telegram_study_bot/downloads/{user_id}_{message.document.file_name}"
